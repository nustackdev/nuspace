...
//
// Both rails are the same furniture on two surfaces, so the row shell is one
// component. What differs is what goes in the lanes, which is why the lane,
// the label and the actions are slots rather than props with opinions.
//
