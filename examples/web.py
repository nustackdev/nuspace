...
One app, ``page``, is a sidebar section: ``+`` makes a plane under it. One
snippet, ``ticker``, is offered from ``/``. A Counter plane is seeded the
...
SNIPPETS = [Snippet("ticker", "Ticker", TICKER)]
